...
const Sales = () => {
  ...
  const perPeriod = useMemo(() => {
    // في الوضع السنوي: كل شهر. في الوضع الشهري: كل يوم.
  ...
  if (!isAdmin)
    return (
      <div className="min-h-screen grid place-items-center text-center px-6">
        <div>
          <p className="font-bold text-lg">هذه الصفحة للإدارة فقط</p>
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <Helmet>
        <title>تقارير المبيعات — جوليث</title>
        <meta name="description" content="تقارير مبيعات جوليث الشهرية والسنوية: عدد الطلبات وقيمتها حسب الفروع وتفاصيل كل طلب." />
      </Helmet>
      <div className="container py-8 max-w-4xl">
        <div className="flex items-center justify-between mb-6 gap-3 flex-wrap">
          ...
          <div className="flex gap-2">
            ...
            <Link to="/orders">
              <Button variant="ghost" size="sm">طلبات اليوم</Button>
            </Link>
            <Link to="/admin">
        ...
        <section className="rounded-2xl border bg-card p-4 mb-8">
          <h2 className="font-bold mb-4">{mode === "year" ? "المبيعات حسب الشهر" : "المبيعات حسب اليوم"}</h2>
        ...
        {/* حسب الفروع */}
        <section className="rounded-2xl border bg-card p-4 mb-8">
          <h2 className="font-bold mb-4">حسب الفروع</h2>
          {byBranch.length === 0 ? (
        ...
        <section className="rounded-2xl border bg-card p-4">
          <h2 className="font-bold mb-4">تفاصيل الطلبات ({filtered.length})</h2>
